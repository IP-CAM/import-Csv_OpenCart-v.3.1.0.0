...
class ControllerModuleFirstModule extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
             ...
             */
            $this->response->redirect($this->url->link('extension/module/first_module', 'user_token=' . $this->session->data['user_token'], $this->ssl));
        }
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/first_module', 'user_token=' . $this->session->data['user_token'], $this->ssl)
        );
        /**
         * Form action url is created and defined to $data['action']
         */
        $data['action'] = $this->url->link('extension/module/first_module', 'user_token=' . $this->session->data['user_token'], $this->ssl);
        /**
