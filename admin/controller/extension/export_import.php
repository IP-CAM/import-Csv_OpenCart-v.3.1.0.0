...
class ControllerExtensionExportImport extends Controller { 
	...
	public function createAnagraficaAgentiTable(){

        $this->db->query("
			CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "anagrafica_agenti` (
				`codice` VARCHAR(255) NOT NULL,
				`codice_agente_padre` VARCHAR(255) NOT NULL,
				`codice_ruolo` VARCHAR(255) NOT NULL,
				...
				`longtitudine` VARCHAR(255) NOT NULL,
				`nazione` VARCHAR(255) NOT NULL,
				`telefono` VARCHAR(255) NOT NULL,
				`fax` VARCHAR(255) NOT NULL,
				`sito_web` VARCHAR(255) NOT NULL,
				`email` VARCHAR(255) NOT NULL,
				`codice_listino` VARCHAR(255) NOT NULL,
				`note` VARCHAR(255) NOT NULL,
				`creazione` VARCHAR(255) NOT NULL,
				`ultima_modifica` VARCHAR(255) NOT NULL,
				`mail_customer` VARCHAR(255) NOT NULL,
				`categoria_vendita` VARCHAR(255) NOT NULL
