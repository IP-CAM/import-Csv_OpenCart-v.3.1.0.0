...
//			}
            ...
            if ($this->user->hasPermission('access', 'extension/module/anagrafica_agenti')){
                $anagrafiche[] = array(
                    ...
                    'href' => $this->url->link('extension/module/anagrafica_agenti', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'extension/export_import')){
                ...
                $anagrafiche[] = array(
                    ...
                    'href' => $this->url->link('extension/export_import', 'user_token=' .$this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            if ($anagrafiche) {
                $data['menus'][] = array(
                    'id'       => 'menu-catalog',
                    'icon'	   => 'fa-tags',
                    'name'	   => $this->language->get('text_anagrafiche'),
                    'href'     => '',
                    'children' => $anagrafiche
                );
            }
